 ...
 * @Description: DownloadManagerPro
 * <ul>
...
public final class DownloadManagerPro {
     ...
     * start download
     *
     * @param request the request of the downloads
     * @return an ID for the download, unique across the system.
     */
    public long startDownload (Request request) {
     ...
     *
     * @param ids the IDs of the downloads to be paused
     * @return the number of downloads actually removed, -1 if exception or method not exist
     */
    ...
    /**
     * get instance of {@link DownloadManager}
     *
     * @return
     */
