...
import cn.maitian.app.library.utils.io.stream.StringBuilderWriter;
 ...
 *
 * @version $Id: IOUtils.java,v 1.1 2019/06/21 03:45:47 mm_Chris Chen Exp $
 */
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream (InputStream input) throws IOException {
        return cn.maitian.app.library.utils.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray (InputStream input) throws IOException {
        cn.maitian.app.library.utils.io.stream.ByteArrayOutputStream output = new cn.maitian.app.library.utils.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link cn.maitian.app.library.utils.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see cn.maitian.app.library.utils.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
